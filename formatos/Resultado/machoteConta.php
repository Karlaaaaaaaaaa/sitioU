...
$fpdf->SetTitle('CONSTANCIA DE TERMINACIÓN CONTADURIA- PDF');
$fpdf->AddPage();
$fpdf->Image('img/machoteC.jpg', 0, 0, 213,300);
 ...
 */
 ...
 $fpdf->Output('MACHOTE CONTADURIA.pdf',"D");
