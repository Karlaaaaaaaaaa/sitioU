...
$fpdf->SetTitle('CARTA PASANTE DERECHO- PDF');
$fpdf->AddPage();
$fpdf->Image('img/small.jpg', 0, 0, 220);
...
$fpdf->AddFont('exmouth', '', 'exmouth_.php');
    ...
    $fpdf->Cell(240, 258,utf8_decode($apellidos), 0, 1,'C');
 ...
 */
 ...
 $fpdf->Output('CARTA PASANTE DERECHO.pdf',"D");
