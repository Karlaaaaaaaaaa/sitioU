...
$fpdf->SetTitle('CARTA PASANTE CONTADURIA- PDF');
$fpdf->AddPage();
$fpdf->Image('img/cpcontaduria.jpg', 0, 0, 220);
...
$fpdf->AddFont('exmouth', '', 'exmouth_.php');
    ...
    $fpdf->Cell(240, 300,utf8_decode($apellidos), 0, 1,'C');
 ...
 */
 ...
 $fpdf->Output('CARTA PASANTE CONTADURIA.pdf',"D");
